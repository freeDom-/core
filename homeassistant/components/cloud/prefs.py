...
class CloudPreferences:
    ...
    async def async_update(
        self,
        *,
        google_enabled: UndefinedType = UNDEFINED,
        alexa_enabled: UndefinedType = UNDEFINED,
        remote_enabled: bool | UndefinedType = UNDEFINED,
        google_secure_devices_pin: UndefinedType = UNDEFINED,
        cloudhooks: dict[str, dict[str, str | bool]] | UndefinedType = UNDEFINED,
        cloud_user: str | UndefinedType = UNDEFINED,
        alexa_report_state: UndefinedType = UNDEFINED,
        google_report_state: UndefinedType = UNDEFINED,
        tts_default_voice: UndefinedType = UNDEFINED,
